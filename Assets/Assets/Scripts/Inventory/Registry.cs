...
public struct RangeDependentAttack
{
    ...
    public RangeDependentAttack(int dist, bool r, int type, float multiplier)
    {
        atDistance = dist;
        ranged = r;
        damageType = type;
...
public struct WeaponType
{
    ...
    public WeaponType(string n, int SRange, int Range, int diagonal, bool rangedWeapon, bool canHeal)
    {
        name = n;
        sRange = SRange;
        range = Range;
    ...
    public WeaponType(string n, int SRange, int Range, int diagonal, bool rangedWeapon, bool canHeal, RangeDependentAttack rda)
    {
        name = n;
        sRange = SRange;
        range = Range;
    ...
    public WeaponType(string n, int SRange, int Range, int diagonal, bool rangedWeapon, bool canHeal, List<RangeDependentAttack> rda)
    {
        name = n;
        sRange = SRange;
        range = Range;
...
public class Registry{
    ...
    public static void FillRegistry()
    {
        ...
        WeaponTypeRegistry.Add(2, new WeaponType("Axe", 0, 1, 1, false, false));
        WeaponTypeRegistry.Add(3, new WeaponType("Unarmed", 0, 1, 0, false, false));
        WeaponTypeRegistry.Add(4, new WeaponType("Shield", 0, 1, 0, false, false));
        WeaponTypeRegistry.Add(5, new WeaponType("Tome", 1, 1, 1, true, false));
        ...
        ItemRegistry.Add("Mirendell", new EquippableBase(0, 0, 0, 0, 13, 0, 20, 500, "A legendary sword. Very shiny"));

        ItemRegistry.Add("Wooden Lance", new EquippableBase(0, 1, 0, 0, 3, 0, 0, 500, "A wooden training lance. Surprisingly sharp for what it is"));
        ItemRegistry.Add("Iron Lance", new EquippableBase(0, 1, 0, 0, 4, 0, 0, 500, "A sturdy lance. Not the best at piercing armor, but will tear through flesh no problem"));
        ItemRegistry.Add("Steel Lance", new EquippableBase(0, 1, 0, 0, 6, 0, 0, 500, "A solid lance that can pierce metal as well as bone"));
        ItemRegistry.Add("Sapphire Lance", new EquippableBase(0, 1, 0, 0, 8, 0, 10, 500, "A gorgeous lance that sparkles with every movement. Horrible for stealth but looks more than fabuluous enough to make up for it"));
        ItemRegistry.Add("Leviantal", new EquippableBase(0, 1, 0, 0, 13, 0, 30, 500, "A legendary lance"));

        ItemRegistry.Add("Wooden Axe", new EquippableBase(0, 2, 0, 0, 3, 0, 0, 500, "A wooden training axe. Not much more than a bludgeoning weapon but whatever"));
        ItemRegistry.Add("Iron Axe", new EquippableBase(0, 2, 0, 0, 6, 0, 0, 500, "As good at cleaving heads as it is wood, this is a good choice for any warrior"));
        ItemRegistry.Add("Steel Axe", new EquippableBase(0, 2, 0, 0, 9, 0, 15, 500, "Cuts through metal armor like butter, this is a well crafted axe that can deal massive damage"));
        ItemRegistry.Add("Xarok", new EquippableBase(0, 2, 0, 0, 12, 0, 35, 500, "A legendary axe"));

        ItemRegistry.Add("Fists", new EquippableBase(0, 3, 0, 0, 2, 1, 0, 500));

        ItemRegistry.Add("Wooden Shield", new EquippableBase(0, 4, 0, 0, 2, 2, 0, 500));
        ItemRegistry.Add("Leather Shield", new EquippableBase(0, 4, 0, 0, 2, 4, 0, 500));
        ItemRegistry.Add("Iron Rimmed Shield", new EquippableBase(0, 4, 0, 0, 3, 6, 0, 500));
        ItemRegistry.Add("Iron Shield", new EquippableBase(0, 4, 0, 0, 3, 8, 0, 500));
        ItemRegistry.Add("Steel Shield", new EquippableBase(0, 4, 0, 0, 5, 10, 0, 500));

        ItemRegistry.Add("A Tome I Guess", new EquippableBase(0, 5, 1, 0, 5, 0, 0, 500));
        ItemRegistry.Add("A Better Tome I Guess", new EquippableBase(0, 5, 1, 0, 7, 0, 0, 500));
        ItemRegistry.Add("An Even Better Tome I Guess", new EquippableBase(0, 5, 1, 0, 10, 0, 0, 500));
        ItemRegistry.Add("The Best Tome I Guess", new EquippableBase(0, 5, 1, 0, 13, 0, 0, 500));

        ItemRegistry.Add("Wooden Bow", new EquippableBase(0, 6, 0, 0, 7, 0, 0, 500));
        ItemRegistry.Add("Iron Bow", new EquippableBase(0, 6, 0, 0, 9, 0, 10, 500));
        ...
        ItemRegistry.Add("Battle Axe", new EquippableBase(0, 2, 0, 0, 6, 0, 0, 500, "Cleaving skulls"));
        ItemRegistry.Add("Bloodstone Necklace", new EquippableBase(6, 1, 1, 5, 2, 0, 0, 1000, "Forged from the blood of my enemies (aka a ruby), this necklace enhances aEtheric spells"));
        ...
        ItemRegistry.Add("Crossbow", new EquippableBase(0, 6, 0, 0, 7, 0, 0, 600, "Sends a deadly projectile through armor or shadowy... things... all the same"));
        ItemRegistry.Add("Dagger", new EquippableBase(0, 0, 0, 0, 2, 0, 0, 500, "A tried and true tool for any job, be it eating, sculpting, or murder"));
        ItemRegistry.Add("Demonic Sword", new EquippableBase(0, 0, 0, 0, 13, 0, 20, 500, "This sword has eyes. Why"));
